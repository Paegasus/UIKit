...
public struct Double4(double v0, double v1, double v2, double v3)
{
    ...
    public static Double4 operator +(in Double4 a, in Double4 b) => new(a.V0 + b.V0, a.V1 + b.V1, a.V2 + b.V2, a.V3 + b.V3);
    public static Double4 operator -(in Double4 a, in Double4 b) => new(a.V0 - b.V0, a.V1 - b.V1, a.V2 - b.V2, a.V3 - b.V3);
    public static Double4 operator *(in Double4 a, in Double4 b) => new(a.V0 * b.V0, a.V1 * b.V1, a.V2 * b.V2, a.V3 * b.V3);
    public static Double4 operator *(in Double4 a, double s) => new(a.V0 * s, a.V1 * s, a.V2 * s, a.V3 * s);

    // {v[2], v[3], v[0], v[1]}
    public static Double4 SwapHighLow(in Double4 v) => new(v.V2, v.V3, v.V0, v.V1);
    // {v[1], v[0], v[3], v[2]}
