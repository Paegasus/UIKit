...
public struct MaskFilterInfo
{
    ...
    public readonly LinearGradient gradient_mask()
    {
#if DEBUG
    Debug.Assert(hasGradientMask_);
#endif
    ...
    public readonly bool HasGradientMask()
    {
        ...
        return hasGradientMask_ && !gradient_mask_.IsEmpty;
    }
    ...
    public void ApplyTransform(in Transform transform)
    {
        ...
        if (hasGradientMask_ && !gradient_mask_.IsEmpty)
        {
            gradient_mask_.ApplyTransform(transform); // mutates directly
        }
    }
    ...
    public readonly bool Equals(in MaskFilterInfo other) =>
                                                            ...
                                                            hasGradientMask_           == other.hasGradientMask_           &&
                                                            (!hasGradientMask_ || gradient_mask_.Equals(other.gradient_mask_));
